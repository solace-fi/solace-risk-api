...
API_KEY = "ckey_a0dadddb07fe400a95879111873"
...
def get_price_history(params):
    ...
    for ticker in tickers:
        try:
            url = f"https://api.covalenthq.com/v1/pricing/historical/USD/{ticker}/?quote-currency=USD&format=JSON&from={start_date}&to={end_date}&key={API_KEY}"
